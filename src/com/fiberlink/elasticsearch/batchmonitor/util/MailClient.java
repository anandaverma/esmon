...
public class MailClient {
	...
	public static void loadProperties() {
		...
		try {
			prop.load(new FileInputStream("resources//mail-client.properties"));
	...
	public static boolean sendPlainMail(String receiverEmailID,
	...
	public static boolean sendPlainMailWithAuthentication(
			String receiverEmailID, String messageSubject, String messageBody,
			String senderEmailID, String senderPassword) {
		loadProperties();
		String subject = new String(messageSubject);
		String body = new String(messageBody);
	...
	public static boolean sendHTMLEmailWithAuthentication(
			String receiverEmailID, String messageSubject, String messageBody,
			String senderEmailID, String senderPassword) {
		final String from = new String(senderEmailID);
		final String pwd = new String(senderPassword);
